...
export default function ProfilePage() {
  ...
  const stats = [
    { label: 'XP Total', value: progress.totalXP || 0, icon: Zap, color: '#F59E0B' },
    { label: 'Streak', value: `${progress.streak || 0}d`, icon: Flame, color: '#F97316' },
    { label: 'Conquistas', value: (progress.unlockedBadges || []).length, icon: Award, color: '#8B5CF6' },
    ...
    <SafeAreaView className="flex-1 bg-purple-50">
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
        ...
        <View className="items-center mb-6">
          <View className="w-24 h-24 rounded-full bg-purple-600 items-center justify-center mb-3 shadow-md">
        ...
        {/* Stats */}
        <Text className="font-bold text-gray-800 text-lg mb-3">Estatísticas</Text>
        ...
        {/* Badges */}
        <Text className="font-bold text-gray-800 text-lg mb-3">Conquistas</Text>
